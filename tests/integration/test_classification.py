...
class TestClassificationWithTaxonomy:
    ...
    def test_classify_atherosclerosis_content_returns_cardiovascular(
        self, indexed_taxonomy
    ):
    ...
    @pytest.mark.integration
    def test_classify_irrelevant_content_returns_low_score(
        self, indexed_taxonomy
    ):
    ...
    @pytest.mark.integration
    def test_classify_cardiovascular_drug_content(
        self, indexed_taxonomy
    ):
    ...
    def test_threshold_filters_low_confidence(self, indexed_taxonomy):
        ...
        chunk = MockChunk(
            id="chunk-4",
            text="The mitochondria is the powerhouse of the cell producing ATP."
        )
